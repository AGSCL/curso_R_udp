...
```{r a, fig.align="center", message=FALSE, warning=FALSE, cache=T, eval=F, echo =T, out.width = "300px"}
library(readr)
...
```{r b, fig.align="center", message=FALSE, warning=FALSE, cache=T, eval=F, echo =T, out.width = "300px"}
encuesta_wide %>%
...
```{r d, fig.align="center", message=FALSE, warning=FALSE, cache=T, eval=F, echo =T, out.width = "350px"}
...
```{r e, fig.align="center", message=FALSE, warning=FALSE, cache=T, eval=F, echo =T, out.width = "300px"}
...
- Introducción a R y la investigación reproducible: 
  - Investigación y software estadístico
...
---
## Software estadístico e Investigación (JOSE)


```{r Fig Meme2, message=FALSE, warning=FALSE, cache=T, echo =F, out.width = "200px"}
...
```{r Fig Meme2, message=FALSE, warning=FALSE, cache=T, echo =F, out.width = "150px"}
knitr::include_graphics("consola.png")
```
...
<div class="centered"> Contacto: gonzalez.santacruz.andres@gmail.com y jose.ruiztaglem@gmail.com </div>
...
pagedown::chrome_print(gsub(".Rmd",".html",rstudioapi::getSourceEditorContext()$path),output="pres_2022_1.pdf")
xaringanBuilder::build_pdf(gsub(".Rmd",".Rmd",rstudioapi::getSourceEditorContext()$path),complex_slides = TRUE,output_file="pres_2022_12.pdf")
xaringanBuilder::build_pdf(gsub(".Rmd",".Rmd",rstudioapi::getSourceEditorContext()$path),complex_slides = TRUE,output_file="pres_2022_13.pdf")
```
